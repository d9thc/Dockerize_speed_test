...
$stats_password="Pa$$w0rd"; //password to login to stats.php. Change this!!!
$enable_id_obfuscation=$(TELEMETRY); //if set to true, test IDs will be obfuscated to prevent users from guessing URLs of other tests
